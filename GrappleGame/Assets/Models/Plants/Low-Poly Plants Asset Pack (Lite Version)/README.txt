Thank you for downloading the Low-Poly Plants Asset Pack (Lite Version) by Game Dev Skill Up!

In order to use the models, just extract the zip file in a suitable location.

Please note that this is the lite version of the asset pack, and only includes 5 of the 15 plants
included in the pack which are: Grass 001, Bush 001, Foliage Plant 001, Mushroom 001 and Cactus 001. 
If you would like access to all 15 assets, you can buy the full version on the same game page.
